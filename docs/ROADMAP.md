...
Tek gerçek kaynak. 11 faz, **94 adım**. Her adım bir PR.
...
**İlerleme:** 42 / 94 — *42 kapandı · 4 kod tamam, cihaz doğrulaması bekliyor · 48 açık.* **Şema v3 yapıldı (F2.8)**, yani Faz 5/6 artık veri yazabilir. **F6.8 bitti**, yani "Her zamankiler" artık dolabiliyor ve Ekran 3 açılabilir hale geldi. **F4.12 ve F6.2 bitti** — üç-sonuç seçici iki ekranda, skor formülü testli ve motor veri üretiyor. Fiş okuma da sertleşti: basılı tarih (F5.8), mağaza adı düzeltmesi (F5.9a), kapı birleştirme (F5.6). **Sırada F6.3** (öneri şeridi) — motorun verisini çipe bağlamak; karar gereken tek şey şeridin otomatik tamamlamayla aynı yeri nasıl paylaşacağı.
