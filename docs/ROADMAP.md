...
**İlerleme:** 2 / 67 tamamlandı · **F1.1** `- [~]` cihaz doğrulaması bekliyor — *sırada **F1.6** (edge-to-edge). Fiş ölçümü paralel izde, sende bekliyor.*
