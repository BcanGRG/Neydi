...
internal fun BosDurum(
    ...
    Column(
        ...
        Text(
            text = when (tur) {
                BosTur.ILK_GUN -> "Listeye başlayalım."
                // "Bos" degil "temiz": ayni gercek, cok farkli his.
                BosTur.DONGU_ORTASI -> "Liste tertemiz."
            },
        ...
        if (tur == BosTur.ILK_GUN && kategoriler.isNotEmpty()) {
            LazyRow(
...
private fun kat(id: String, ad: String) = Category(id, ad, 0, 0xFF6E8B3D)

@PreviewLightDark
@Composable
private fun BosIlkGunPreview() = NeydiPreview {
    BosDurum(
        tur = BosTur.ILK_GUN,
        kategoriler = listOf(kat("1", "Meyve-Sebze"), kat("2", "Fırın-Ekmek"), kat("3", "Süt-Kahvaltılık")),
        panoVar = true,
        onKategori = {},
        onPano = {},
    )
...
@PreviewLightDark
@Composable
private fun BosDonguOrtasiPreview() = NeydiPreview {
    BosDurum(
        tur = BosTur.DONGU_ORTASI,
