 ...
 *
 * Bu arayuz YAPI KURMUYOR, sadece metin donuyor. Yapiyi [parseReceipt] kuruyor
...
interface ReceiptReader {
     ...
     */
    suspend fun readLines(imagePath: String, forceRotation: Int? = null): Result<List<String>>
}
