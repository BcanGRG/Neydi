...
class ListeRepository(
    ...
    fun aktifAlisveris(householdId: String): Flow<Trip?> = tripDao.observeActive(householdId)
     ...
     */
    suspend fun aktifAlisverisiAcVeyaAl(householdId: String): Trip {
    ...
    suspend fun alisverisiBitir(tripId: String) = tripDao.complete(tripId, saat())
