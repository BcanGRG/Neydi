 ...
 */
internal class MlKitFisOkuyucu(private val context: Context) : FisOkuyucu {

    private val tanimlayici = TextRecognition.getClient(TextRecognizerOptions.DEFAULT_OPTIONS)

    override suspend fun satirlariOku(gorselYolu: String): Result<List<String>> = runCatching {
        ...
        satirlariSiralayaraKCikar(metin)
    }
}
 ...
 */
internal fun satirlariSiralayaraKCikar(metin: Text): List<String> =
    metin.textBlocks
